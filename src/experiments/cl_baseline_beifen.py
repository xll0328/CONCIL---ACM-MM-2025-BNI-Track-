...
This file is a backup/alternative variant of the baseline continual learning script.
For reproduction, use cl_baseline.py (baseline) or CONCIL_1114.py (CONCIL).
"""
import os
import sys
