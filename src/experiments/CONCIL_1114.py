...
class IncrementalIMGTrainer(BASETrainer):
    ...
    def train_incrementally(self):
        ...
        for stage in range(self.num_stages):
            ...
            #         self.save_model(stage, self.epoch - 1)
                ...
                if self.args.dataset == 'awa':
                    path_to_checkpoint = '/hpc2hdd/home/songninglai/CBM_CL/base_mode_awal/2024-11-14-07:36:31/AWA.pth'
                else:
                    path_to_checkpoint = "/hpc2hdd/home/songninglai/CBM_CL/base_model/CUB/CUB.pth"
    ...
    def test(self, stage):
        ...
        # Compute forgetting rates for previous tasks (paper: best accuracy so far for task k minus current accuracy for task k)
        if stage > 0:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-saved_dir', type=str, default='results_test_new', help='path to save results')
    ...
    parser.add_argument('-num_stages', type=int, default=8, help='number of incremental stages')
    parser.add_argument('-buffer_size', type=int, default=25000, help='buffer_size')
    parser.add_argument('-gg', type=float, default=1e-1, help='nnnn')
    parser.add_argument('-gg1', type=float, default=500, help='concept')
    parser.add_argument('-gg2', type=float, default=1, help='class')
