"""
Baseline continual learning for CBM: gradient-based incremental training.
Used in the paper for comparison with CONCIL. Run with: python src/experiments/cl_baseline.py ...
"""
import os
import sys
