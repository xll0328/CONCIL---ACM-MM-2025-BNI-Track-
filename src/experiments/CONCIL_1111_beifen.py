...
Backup variant of CONCIL_1111. For paper reproduction use CONCIL_1114.py.
"""
import os
import sys
...
if __name__ == '__main__':
    ...
    parser.add_argument('-epoch', '-e', type=int, default=1, help='epochs for each training stage')
    ...
    parser.add_argument('-num_stages', type=int, default=5, help='number of incremental stages')
    parser.add_argument('-buffer_size', type=int, default=8192, help='buffer_size')
    parser.add_argument('-gg', type=int, default=1e-3, help='buffer_size')
