...
Earlier variant of CONCIL (CONCIL_1111). For paper reproduction use CONCIL_1114.py.
"""
import os
import sys
...
class CONCIL(nn.Module):
    def __init__(self, num_concepts: int, num_classes: int,
        ...
        self.analytic_linear_concept = linear(buffer_size, gg, **factory_kwargs)
        self.analytic_linear_class = linear(buffer_size, gg, **factory_kwargs)
...
class IncrementalIMGTrainer(BASETrainer):
    ...
    def save_model(self, stage, epoch):
        ...
        torch.save(self.model1.state_dict(), path_to_checkpoint)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-conecpt_ratio', type=float, default=0.5, help='initial ratio of concepts used')
