...
if __name__ == '__main__':
    ...
    parser.add_argument('-epoch', '-e', type=int, default=2, help='epochs for each training stage')
    ...
    parser.add_argument('-num_stages', type=int, default=3, help='number of incremental stages')
    args = parser.parse_args()
